        ...
        String url = System.getProperty("cloudsql");
         ...
         try(ResultSet rs = conn.prepareStatement(ingroupalready).executeQuery()) {
          ...
          <div class="w3-container">
            <h1 align = "center"> <%=groupformalname%></h1>
            <div align = "center">
                <h3 id = "myBtn" align = "center"> <%=groupsize%> Members </h3>
            </div>
            ...
            &nbsp
                        <form action = "/leavegroup" method = post target="_self">
                            ...
                            <div align = "center">
                                <button type="submit" class="btn btn-primary" style="height:10%;width:200px;background-color:red;"> Leave Group </button>
                            </div>
                        </form>
